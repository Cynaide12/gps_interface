...
func SetActiveGeofence(log *slog.Logger, coordinatesHandler CoordinatesHandler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		const fn = "http-server.handlers.coordinates.SetActiveGeofence"
		...
		err := coordinatesHandler.SetActiveGeofence(req)
		if err != nil {
